...
import com.JHPay.query.application.port.out.GetMoneySumByAddressPort;
...
public class DynamoDBAdapter implements GetMoneySumByAddressPort, InsertMoneyIncreaseEventByAddress {
    ...
    private static final String ACCESS_KEY = "AKIAR62GP44Z6H2OJUPY";
    private static final String SECRET_KEY = "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";
    private final DynamoDbClient dynamoDbClient;

    private final MoneySumByAddressMapper moneySumByAddressMapper;


//    public DynamoDBAdapter(@Value("${aws.dynamodb.access}") String ACCESS_KEY, @Value("${aws.dynamodb.secret}") String SECRET_KEY) {
